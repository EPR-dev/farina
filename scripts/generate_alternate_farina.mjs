...
const anchors = [
  ...
  },
  {
    ...
    w: 0.0012,
    h: 0.0008,
    reasoning: "Plausible remote-town renewable infrastructure — speculative.",
  },
  {
    id: "alt_plaza_2026",
    ...
    addPoly(
      {
        ...
        label: "Illustrative reconstruction",
        labelRank: 3,
        mapKind: "dwelling",
        useClass: "dwelling",
      },
  ...
  addPoint(
    {
      ...
      reasoning:
        p.reasoning ||
        "Scenario assumption bounded by Quorn/Hawker/Marree comparisons — not a census figure.",
      label: `Scenario population: ${p.value.toLocaleString()}`,
    },
...
const fc = {
  ...
  properties: {
    ...
    notes:
      "All features speculative. Generated by scripts/generate_alternate_farina.mjs from population.json + parcel grid. Keep separate from documented historical layers.",
  },
  features,
};
